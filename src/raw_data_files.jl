...
raw_file_map() = Dict([
    ...
    :fracGrad => raw_frac_gradc_qual_gpa,
    :fracGrad_gV => raw_frac_gradc_qual_gpa,
    :fracGrad_qV => raw_frac_gradc_qual_gpa,
    :fracGrad_gpM => raw_frac_gradc_qual_parental,
    :fracGrad_qgM => raw_frac_gradc_qual_gpa,
    :mass_gpM => raw_mass_gpa_parental,
    :massEntry_qgM => raw_mass_entry_qual_gpa,
    :massEntry_qpM => raw_mass_entry_qual_parental,
