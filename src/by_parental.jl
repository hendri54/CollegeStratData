function frac_enter_by_parental(ds :: DataSettings)
    ...
    m = read_row_totals(raw_entry_gpa_parental());
...
## Hours worked, year 1
function work_hours_by_parental(ds :: DataSettings;  modelUnits :: Bool = true)
    target = :workTime_pV;
    m = read_col_totals(raw_work_hours_qual_parental());
